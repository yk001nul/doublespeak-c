...
(These outputs are from the `imp/text-coherence-opt` branch, where de-themed prompts and a shorter sentence cap reduced the earlier cross-topic vocabulary drift; decoding still matches each covertext exactly via prefix matching.)
