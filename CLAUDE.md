...
### Sample style-mode outputs (verified 2026-07-12, commit `1a4869a`, branch `imp/text-coherence-opt`, threads=4)
...
|---|---|---|---|
| `INFORMAL_CHAT` | John goes to the office using his car every morning. | `hi` | he heads to the office to avoid meeting tight deadlines to the business district. his ride to the heart of commerce to ensure timely project completion to meet clients. that drives to the biz district to meet investors by car. the office daily with the project managers. his commute starts to ensure timely project completion by his trusty vehicle. he drives to meet investors to avoid stress from rush hour. |
| `NEWS_ARTICLE` | The government announced new policies to reduce carbon emissions by 2030. | `hi` | it introduces to avoid reliance on fossil fuels to coastal regions. it mandates to achieve carbon neutrality to join carbon reduction coalitions. this initiative progresses to join global sustainability partners through policy reform. a plan for environmental sustainability to meet sustainability experts. |
| `CASUAL_BLOG` | Sarah spent the whole weekend hiking in the mountains with her dog. | `hi` | he spent while avoiding rocky terrain to the summit. her dog and me to enjoy fresh air to join a mountain rescue team. a small but perceptible change to meet a fellow dog owner using a map. the journey up the peaks. |
| `FORMAL_EMAIL` | The team will present the quarterly results to stakeholders on Friday. | `hi` | the team will present to avoid unnecessary delays at the quarterly meeting venue. they report to share insights to meet stakeholders. it evolves to meet investors by leveraging analytics. they compile with marketing department. they report to ensure transparency through strategic planning. the team assembles. |

These samples reflect the de-themed axis prompts and the `CLAUSE_END_MAX_PHRASES=3` sentence cap on `imp/text-coherence-opt`: vocabulary now tracks each topic (contrast the earlier office/commute drift) and sentences are shorter. Residual mild awkwardness in some stacked modifiers is being iterated on.
